...
int Program::SetUp()
{
    ...
    /* Shaders */
    m_Shader_AnimModels.ExtendedSetUp(SHADER_FOLDER_DIR + "AnimatedModels.glsl");
    m_Shader_AnimModels.SetBonesUniform();
    m_Shader_PlainModels.ExtendedSetUp(SHADER_FOLDER_DIR + "NonAnimatedModels.glsl");
    m_Shader_Terrain.SetUp(SHADER_FOLDER_DIR + "Terrain.glsl");
